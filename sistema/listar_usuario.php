...
<?php include("includes/header.php"); ?>
    <section id="container">
        <h1><i class="fas fa-clipboard-list"></i> Lista de Usuario</h1>
        ...
        INNER JOIN tb_genero g ON u.TIPOGENE= g.IDGENERO INNER JOIN tb_rol r ON u.IDROL = r.IDROL WHERE ESTADO ='Activo' ORDER BY IDUSU ASC LIMIT $desde,$por_pagina");
